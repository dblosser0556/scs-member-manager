...
<div class="container">
    ...
    <form id="applyform" class="needs-validation" novalidate>
        ...
        <div class="form-row"
            style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray;height:30px;">
        ...
        <div class="form-row">
            ...
            <div class="col-md-4 mb-2">
                ...
                <div class="input-group">
                    ...
                    value="<?=$member->username?>" aria-describedby="inputGroupPrepend" required />
                    <div class="invalid-feedback">
