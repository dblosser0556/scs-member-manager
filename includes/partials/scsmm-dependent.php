<tr <?= $i == 0 ? 'style="display:none"' : '' ?> id="row<?=$i?>" class="dependant-row">
    <td>
        <input type="text" hidden id="id" name="id" data-row="row<?=$i?>" value="<?= $i>0 ? $dependants[$i-1]->id : ''?>" />
        <input type="text" hidden id="membershipid" name="membershipid" data-row="row<?=$i?>" value="<?= $i>0 ? $dependants[$i-1]->membershipid : ''?>" />
        ...
        <div class="form-row">
            <div class="col-md-4 mb-2">
                ...
                <input type="text" class="form-control" data-row="row<?=$i?>" id="firstname" name="firstname<?=$i?>"
                    placeholder="First name" value="<?= $i>0 ? $dependants[$i-1]->firstname : ''?>" required <?= $readonly ? 'readonly' : '' ?>/>
            ...
            <div class="col-md-4 mb-2">
                ...
                <input type="text" class="form-control" data-row="row<?=$i?>" id="lastname" name="lastname<?=$i?>"
                    placeholder="Last name" value="<?=  $i>0 ? $dependants[$i-1]->lastname : ''?>" required <?= $readonly ? 'readonly' : '' ?>>
                <div class="invalid-feedback">
        ...
        <div class="form-row">
            <div class="col-md-4 mb-2">
                ...
                <input type="tel" class="form-control" id="phone" data-row="row<?=$i?>" name="phone<?=$i?>"
                    ...
                    value="<?= $i>0 ? $dependants[$i-1]->phone : '' ?>" <?= $readonly ? 'readonly' : '' ?>/>
            ...
            <div class="col-md-4 mb-2">
                ...
                <input type="tel" class="form-control" id="mobile" data-row="row<?=$i?>" name="mobile<?=$i?>"
                    ...
                    value="<?= $i>0 ? $dependants[$i-1]->mobile : '' ?>" <?= $readonly ? 'readonly' : '' ?>/>
                <small id="emailHelp" class="form-text text-muted">Like (555) 555-5555.</small>
                <div class="invalid-feedback">
            ...
            <div class="col-md-4 mb-2">
                ...
                <input type="email" class="form-control" id="email" data-row="row<?=$i?>" name="email<?=$i?>"
                    placeholder="Email" value="<?= $i>0 ? $dependants[$i-1]->email : ''?>" <?= $readonly ? 'readonly' : '' ?>/>
